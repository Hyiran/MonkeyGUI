...
public class GUI_RegularKey_RandomTime_SuccessSet extends JFrame implements
		Runnable {
	...
	public GUI_RegularKey_RandomTime_SuccessSet() {
		createUserInterface();
	...
	private String createUserInterface() {
		...
		KeySet = new JLabel("设置的键值共有：" + Map.size() + "个，按先后顺序分别是："
				+ KeySetStr1);
		...
		LoopTi = new JLabel("循环时间为：" + Middle_param.getTimeStart()+"至"+Middle_param.getTimeEND()+"秒内随机");
		...
		Image imgbackground = Toolkit.getDefaultToolkit().getImage(
				GUI_RegularKey_RandomTime_SuccessSet.class.getClassLoader().getResource(
	...
	public GUI_RegularKey_RandomTime_SuccessSet objsuccess=null;
	public void GetObject(GUI_RegularKey_RandomTime ob,GUI_RegularKey_RandomTime_SuccessSet obsuccess) {
		// TODO Auto-generated method stub
		obj=ob;
	...
	public static void main(String[] args) {
		...
		GUI_RegularKey_RandomTime_SuccessSet successset = new GUI_RegularKey_RandomTime_SuccessSet();
