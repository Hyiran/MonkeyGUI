...
public class GUI_RegularKey_RegularTime_SuccessSet extends JFrame implements
		Runnable {
	...
	public GUI_RegularKey_RegularTime_SuccessSet() {
		createUserInterface();
	...
	private String createUserInterface() {
		...
		Image imgbackground = Toolkit.getDefaultToolkit().getImage(
				GUI_RegularKey_RegularTime_SuccessSet.class.getClassLoader().getResource(
	...
	public GUI_RegularKey_RegularTime_SuccessSet objsuccess=null;
	public void GetObject(GUI_RegularKey_RegularTime ob,GUI_RegularKey_RegularTime_SuccessSet obsuccess) {
		// TODO Auto-generated method stub
		obj=ob;
	...
	/*public static void main(String[] args) {
		...
		GUI_RegularKey_RegularTime_SuccessSet successset = new GUI_RegularKey_RegularTime_SuccessSet();
