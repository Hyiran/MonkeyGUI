...
public class GUI_RandomKey_RandomTime_SuccessSet extends JFrame implements
		Runnable {
	...
	public GUI_RandomKey_RandomTime_SuccessSet() {
		createUserInterface();
	...
	private String createUserInterface() {
		...
		Image imgbackground = Toolkit.getDefaultToolkit().getImage(
				GUI_RandomKey_RandomTime_SuccessSet.class.getClassLoader().getResource(
	...
	public GUI_RandomKey_RandomTime_SuccessSet objsuccess=null;
	public void GetObject(GUI_RandomKey_RandomTime ob,GUI_RandomKey_RandomTime_SuccessSet obsuccess) {
		// TODO Auto-generated method stub
		obj=ob;
	...
	public static void main(String[] args) {
		...
		GUI_RandomKey_RandomTime_SuccessSet successset = new GUI_RandomKey_RandomTime_SuccessSet();
