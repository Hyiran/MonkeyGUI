...
public class GUI_RegularKey_RandomTime extends JFrame implements Runnable{

	private JPanel userJPanel, userJPanel1;
	private JButton RegularKey_RandomTime_OkJButton, btnSelect, RegularKey_RandomTime_BackJButton;
	...
	private JLabel IP2, LoopCount2, LoopTime2,LoopTime3, pictureJlabelBackground,
	...
	public GUI_RegularKey_RandomTime() {
	...
	private void createUserInterface() {
		...
		LoopTime.setBounds(boundsuserJPanel1.width / 3, LoopTimebounds.y,
				boundsuserJPanel1.width / 15, boundsuserJPanel1.height / 12);
		LoopTime.setFont(new Font("楷体", Font.BOLD,
				boundsuserJPanel1.height / 25));
		LoopTime.setForeground(new Color(0x43,0x6E,0xEE));
		LoopTime4 = new JTextField();
		LoopTime4.setBounds((boundsuserJPanel1.width / 100)*45, LoopTimebounds.y,
				boundsuserJPanel1.width / 15, boundsuserJPanel1.height / 12);
		...
		LoopTime3.setBounds((boundsuserJPanel1.width / 100)*41,
				LoopTimebounds.y, (boundsuserJPanel1.width / 100)*4,
				boundsuserJPanel1.height / 12);
		...
		RegularKey_RandomTime_OkJButton = new JButton("确认");
		RegularKey_RandomTime_OkJButton
				.setBounds(bounds.x + bounds.width / 5, bounds.y
						+ (bounds.height / 6) * 5, bounds.width / 9,
						bounds.height / 20);
		RegularKey_RandomTime_OkJButton.setContentAreaFilled(false);
		 // 此颜色值随便设置，只起占位作用，但是必须加上此句，否则不会出现透明背景效果。
		RegularKey_RandomTime_OkJButton.setFont(new Font("楷体", Font.BOLD,
				boundsuserJPanel1.height / 20));
		RegularKey_RandomTime_OkJButton.setForeground(new Color(0x0A,0x0A,0x0A));
		RegularKey_RandomTime_OkJButton.setFocusPainted(false);
		contentPane.add(RegularKey_RandomTime_OkJButton);
		RegularKey_RandomTime_OkJButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent event) {
				...
				okJButtonAction.RegularKey_RandomTime_OkJButtonActionPerformed(event, SeleFolder.getText(), IP_Port, LoopCount.getText(),  1, 0, map, LoopTime.getText(), LoopTime4.getText(), "1",obj);
			}
		});

		 RegularKey_RandomTime_BackJButton = new JButton("返回");
		 RegularKey_RandomTime_BackJButton
				.setBounds(bounds.x + (bounds.width / 5) * 3, bounds.y
						+ (bounds.height / 6) * 5, bounds.width / 9,
						bounds.height / 20);
		 RegularKey_RandomTime_BackJButton.setContentAreaFilled(false);
		; // 此颜色值随便设置，只起占位作用，但是必须加上此句，否则不会出现透明背景效果。
			// okJButton.setIcon(new
			// ImageIcon("bin/filechooser/image/rec.gif"));
		 RegularKey_RandomTime_BackJButton.setFont(new Font("楷体", Font.BOLD,
				boundsuserJPanel1.height / 20));
		 RegularKey_RandomTime_BackJButton.setForeground(new Color(0x0A,0x0A,0x0A));
		 RegularKey_RandomTime_BackJButton.setFocusPainted(false);
		contentPane.add( RegularKey_RandomTime_BackJButton);
		 RegularKey_RandomTime_BackJButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent event) {
				GUI_Button_Monitor backJButtonAction =new GUI_Button_Monitor();
				backJButtonAction. RegularKey_RandomTime_BackJButtonActionPerformed(event,obj);
			}
		});
		...
		LogoJLabel.setText("固定键值、随机时间间隔");
		...
		Image imgbackground = Toolkit.getDefaultToolkit().getImage(
				GUI_RegularKey_RandomTime.class.getClassLoader().getResource(
	...
	public GUI_RegularKey_RandomTime obj=null;
	
	public void GetObject(GUI_RegularKey_RandomTime ob) {
	...
	public static void main(String[] args) {
		...
		GUI_RegularKey_RandomTime mylogin = new GUI_RegularKey_RandomTime();
