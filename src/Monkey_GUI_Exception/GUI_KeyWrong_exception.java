...
import Monkey_GUI.GUI_Button_Monitor;
import Monkey_Methods.Methods;

public class GUI_KeyWrong_exception extends JFrame {
	...
	private String createUserInterface() {
		...
		// 提示
		Prompt1 = new JLabel(
				"键值未连续！请填写第"+GUI_Button_Monitor.getMapTrue()+"个键值.");
		Prompt1.setBounds(bounds.x + bounds.width / 30, bounds.y + bounds.height
		...
		Image img = Toolkit.getDefaultToolkit().getImage(
				GUI_KeyWrong_exception.class.getClassLoader().getResource(
						"Tray.png"));
	...
	public static void main(String[] args) {
		...
		GUI_KeyWrong_exception close = new GUI_KeyWrong_exception();
