...
public class GUI_TextNULL_exception extends JFrame {
	...
	private String createUserInterface() {
		...
		Image img = Toolkit.getDefaultToolkit().getImage(
				GUI_TextNULL_exception.class.getClassLoader().getResource(
						"Tray.png"));
	...
	public static void main(String[] args) {
		...
		GUI_TextNULL_exception close = new GUI_TextNULL_exception();
